...
from SkullModPy.LVL.SGI import SGI
from SkullModPy.LVL.SGM import SGM
    ...
    def __init__(self, file_path):
        ...
        for element in sgi_data:
            ...
            for vertex in current_sgm['vertices']:
                ...
                vertex_list.append(
                    ['{:6g}'.format(x), '{:6g}'.format(y), '{:6g}'.format(z)])
...
def collada_export(file_path, texture_directory, scene_name, sgm_data, sgi_data):
    ...
    with open(file_path, 'w', encoding='utf-8') as file:
        ...
        file.write(tag('authoring_tool', False) + 'SkullModPy v'
                   + APPLICATION_VERSION + ' ' + APPLICATION_DATE + tag('authoring_tool'))

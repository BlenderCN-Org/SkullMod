...
class Reader():
    ...
    def __init__(self, file, file_size, endianness=LITTLE_ENDIAN):
    ...
    def bits_to_int(self, source_bytes, bit_offset, bit_length):
        ...
        converted_int = self.read_int(bytes_to_read, endianness=BIG_ENDIAN, source_bytes=extracted_bytes)
    ...
    def export_files(self, output_description):
        """
        Export files, for details see param
